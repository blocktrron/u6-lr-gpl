...
/* extern dcm api */
extern int mt_dcm_topckg_enable(void);
extern int mt_dcm_topckg_disable(void);
...
static const struct mtk_i2c_compatible leopard_compat = {
...
static const struct of_device_id mtk_i2c_of_match[] = {
	{ .compatible = "mediatek,leopard-i2c", .data = &leopard_compat },
...
static int mtk_i2c_clock_enable(struct mtk_i2c *i2c)
{
	...
	/* disable dcm to avoid infra reduction */
