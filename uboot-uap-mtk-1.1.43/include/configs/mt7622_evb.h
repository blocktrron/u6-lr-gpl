...
#else
#define CONFIG_SYS_LOAD_ADDR                0x5007FF28
#endif
#endif
...
#define CONFIG_NOR_UBOOT_SIZE              0x60000 //Uboot max size 256k
...
#define CONFIG_STANDALONE_LOAD_ADDR 0x4007ff28
...
#define CONFIG_UBNT_APP     1
#define UBNT_PERSISTENT_LOG 1
#define UBNT_LOG_BUFF_SIZE  (128 * 1024) // 128Kb
...
// jeffrey: TODO move to other place
