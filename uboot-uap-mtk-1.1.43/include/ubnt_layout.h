...
#define UBNT_PART_PRELOADER_NAME            "Preloader"
#define UBNT_PART_ATF_NAME                  "ATF"
...
#define UBNT_PART_PRELOADER_SIZE            (UBNT_PART_PRELOADER_KSIZE  << KILOBYTES_SHIFT)
#define UBNT_PART_ATF_SIZE                  (UBNT_PART_ATF_KSIZE        << KILOBYTES_SHIFT)
...
#define UBNT_PART_PRELOADER_OFF             0x00000
#define UBNT_PART_ATF_OFF                   (UBNT_PART_PRELOADER_OFF    + UBNT_PART_PRELOADER_SIZE)
#define UBNT_PART_UBOOT_OFF                 (UBNT_PART_ATF_OFF          + UBNT_PART_ATF_SIZE)
