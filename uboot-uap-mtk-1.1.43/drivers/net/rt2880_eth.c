...
#define	MAC_TO_GIGAPHY_MODE
      ...
      && !defined(CONFIG_MT7531) && !defined(CONFIG_RTL8367) \
      && !defined(CONFIG_SWITCH_NONE)
...
#define PWR_SRAM_PDN_LSB	8
	...
	*(volatile u_long *)(POWRON_CONFIG_EN) = 0x0B160001;
    ...
    || (defined (GE_RGMII_FORCE_1000) && defined(CONFIG_USE_GE2))
...
{
#if defined(CONFIG_MT7531)
#if defined (GE_RGMII_FORCE_1000) && defined (CONFIG_USE_GE2)
	struct mt7531_port_cfg port5_cfg = {
	...
	*(volatile u_long *)(0x1b00002c) &= ~(1<<11);
#elif defined (GE_RGMII_FORCE_1000) && defined (CONFIG_USE_GE2)
	external_switch_reset();

#if defined(CONFIG_MT7531)
	mt7531_sw_init(&port5_cfg, NULL);
#elif defined(CONFIG_RTL8367)
	rtl8367_sw_init();
#endif
...
#if defined(MT7622_ASIC_BOARD)
        // 5.1.77 Autonegotiation Receive Reserved Vendor Provisioning 1: Address 7.E410
        run_command("mdio45.w 8 7 58384 0x0", 0);
        printf("Enable aqr112c 100Mbps link detection\n");
#endif
	}
	else
	{
...
#if defined(GE_RGMII_FORCE_1000)
#if defined (CONFIG_USE_GE1)
	*(volatile u_long *)(ETHDMASYS_ETH_SW_BASE + 0x100) = 0x2105e30b;
#elif defined (CONFIG_USE_GE2)
	*(volatile u_long *)(ETHDMASYS_ETH_SW_BASE + 0x200) = 0x2105e30b;
#endif /* CONFIG_USE_GE1 */
#endif /* GE_RGMII_FORCE_1000 */
